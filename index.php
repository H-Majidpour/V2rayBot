...
if($data == "bestgigBack"){
    ...
    bot('sendMessage',[
        ...
        [
            ...
            ['text'=>"50 گیگ",'callback_data'=>"chlgig"]
        ],
        [
            ['text'=>"75 گیگ",'callback_data'=>"shastgig"],
...
if($res4 == 0){
    ...
    bot('sendMessage',[
        ...
        [
            ...
            ['text'=>"50G",'callback_data'=>"ChlPangGig50Gu"],
        ],
        [
            ['text'=>"75G",'callback_data'=>"ShastGig75Gu"],
...
if($res4 == 0){
    ...
    bot('sendMessage',[
        ...
        [
            ...
            ['text'=>"50G",'callback_data'=>"ChlPangGig50"],
        ],
        [
            ['text'=>"75G",'callback_data'=>"Shastgig75"],
...
if($res4 == 0){
    ...
    bot('sendMessage',[
        ...
        [
            ...
            ['text'=>"50G",'callback_data'=>"ChlPangGig50G"],
        ],
        [
            ['text'=>"75G",'callback_data'=>"Shastgig75G"],
...
$sql2233    = "SELECT * FROM vpn WHERE contry = 'germany' AND hajm = '75' LIMIT 1";
$result2233 = mysqli_query($conn,$sql2233);
$res2233 = mysqli_fetch_assoc($result2233);
$trsrul2233  = $res2233['code'];
...
function serves(){
    ...
    global $chat_id;
    global $conn;
$sql1    = "SELECT * FROM `vpn` WHERE contry='germany'";
$result1 = mysqli_query($conn,$sql1);
$res1    = mysqli_num_rows($result1);

$sql2    = "SELECT * FROM `vpn` WHERE `contry`='finland'";
$result2 = mysqli_query($conn,$sql2);
...
$res3    = mysqli_num_rows($result3);
    ...
    bot('sendMessage',[
        ...
        'inline_keyboard'=>[
        [
            ['text'=>"🇩🇪 آلمان",'callback_data'=>"ddddddd"],
            ['text'=>"$res1",'callback_data'=>"ddddddd"],
            
        ],
        [
            ['text'=>"🇫🇮 فنلاند",'callback_data'=>"ddddddd"],
...
function pay_server(){
    ...
    bot('sendMessage',[
        ...
        'inline_keyboard'=>[
        [
            ['text'=>"🇩🇪 آلمان",'callback_data'=>"germany"]
        ],
        [
            ['text'=>"🇫🇮 فنلاند",'callback_data'=>"finland"]
        ],
        [
...
function moton(){
    ...
    bot('sendMessage',[
        ...
        [
            ['text'=>"📝 متن اکانت تست",'callback_data'=>"servertest"],
        ],
        [
